...
"""
import abc
import flwr_custom.proto.fleet_pb2
import grpc

class FleetStub:
    def __init__(self, channel: grpc.Channel) -> None: ...
    PullTaskIns: grpc.UnaryUnaryMultiCallable[
        flwr_custom.proto.fleet_pb2.PullTaskInsRequest,
        flwr_custom.proto.fleet_pb2.PullTaskInsResponse ]
    ...
    PushTaskRes: grpc.UnaryUnaryMultiCallable[
        flwr_custom.proto.fleet_pb2.PushTaskResRequest,
        flwr_custom.proto.fleet_pb2.PushTaskResResponse ]
...
class FleetServicer(metaclass=abc.ABCMeta):
    ...
    def PullTaskIns(self,
                    request: flwr_custom.proto.fleet_pb2.PullTaskInsRequest,
    ...
    def PushTaskRes(self,
                    request: flwr_custom.proto.fleet_pb2.PushTaskResRequest,
                    context: grpc.ServicerContext,
                    ) -> flwr_custom.proto.fleet_pb2.PushTaskResResponse:
        """Complete one or more tasks, if possible
