...
import flwr_custom.proto.task_pb2
...
class PullTaskInsRequest(google.protobuf.message.Message):
    ...
    @property
    def node(self) -> flwr_custom.proto.node_pb2.Node: ...
    @property
    def task_ids(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[typing.Text]: ...
    def __init__(self,
                 *,
                 node: typing.Optional[flwr_custom.proto.node_pb2.Node ] = ...,
...
class PullTaskInsResponse(google.protobuf.message.Message):
    ...
    @property
    def task_ins_list(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[flwr_custom.proto.task_pb2.TaskIns ]: ...
    def __init__(self,
                 *,
                 reconnect: typing.Optional[global___Reconnect] = ...,
                 task_ins_list: typing.Optional[typing.Iterable[flwr_custom.proto.task_pb2.TaskIns ] ] = ...,
                 ) -> None: ...
...
class PushTaskResRequest(google.protobuf.message.Message):
    ...
    @property
    def task_res_list(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[flwr_custom.proto.task_pb2.TaskRes ]: ...
    def __init__(self,
                 *,
                 task_res_list: typing.Optional[typing.Iterable[flwr_custom.proto.task_pb2.TaskRes ] ] = ...,
                 ) -> None: ...
