...
"""
import builtins
import flwr_custom.proto.node_pb2
import flwr_custom.proto.transport_pb2
...
class Task(google.protobuf.message.Message):
    ...
    @property
    def producer(self) -> flwr_custom.proto.node_pb2.Node: ...
    @property
    def consumer(self) -> flwr_custom.proto.node_pb2.Node: ...
    ...
    @property
    def legacy_server_message(self) -> flwr_custom.proto.transport_pb2.ServerMessage: ...
    @property
    def legacy_client_message(self) -> flwr_custom.proto.transport_pb2.ClientMessage: ...
    def __init__(self,
                 *,
                 producer: typing.Optional[flwr_custom.proto.node_pb2.Node ] = ...,
                 consumer: typing.Optional[flwr_custom.proto.node_pb2.Node ] = ...,
                 created_at: typing.Text = ...,
                 delivered_at: typing.Text = ...,
                 ttl: typing.Text = ...,
                 ancestry: typing.Optional[typing.Iterable[typing.Text]] = ...,
                 legacy_server_message: typing.Optional[flwr_custom.proto.transport_pb2.ServerMessage ] = ...,
                 legacy_client_message: typing.Optional[flwr_custom.proto.transport_pb2.ClientMessage ] = ...,
                 ) -> None: ...
